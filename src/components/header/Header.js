      ...
      <div className="wraper">
        <div className="flex items-center justify-between">
          ...
          <div className="w-[195px] md:w-[280px] sm:w-[200px] col:w-[50px]">
            <Link
              className="text-[45px] col:text-[25px] font-bold flex items-center md:justify-center text-white"
              to="/"
            >
              <img className=" rounded-[50%] mr-[10px] " src={Logo} alt="" />
              TnVr.
            </Link>
          </div>
              ...
              {/* <ul className="absolute w-[240px]  left-0 top-[110%] p-[20px] z-[111]  bg-[#fff] shadow-[#3e419f17]  transition-all  opacity-0 invisible
                    group-hover:opacity-100  group-hover:top-full group-hover:visible">
                            ...
                            hover:after:w-full">Main Home</NavLink>
                                ...
                                <li>
                                    <NavLink onClick={ClickHandler} to="/home2" className="text-[16px] lg:text-[14px] inline-block py-[5px] capitalize text-[#202020] group relative overflow-hidden font-medium transition-all 
                            after:absolute after:left-0 after:bottom-[5px] after:w-0 after:h-[1px] after:content after:bg-[#59C378]  after:transition-all 
                            hover:after:w-full">Home Style 2</NavLink>
                                </li>
                                <li>
                                    <NavLink onClick={ClickHandler} to="/home3" className="text-[16px] lg:text-[14px] inline-block py-[5px] capitalize text-[#202020] group relative overflow-hidden font-medium transition-all 
                            after:absolute after:left-0 after:bottom-[5px] after:w-0 after:h-[1px] after:content after:bg-[#59C378]  after:transition-all 
                            hover:after:w-full">Home Style 3</NavLink>
                                </li>
                            </ul> */}
            </li>
          ...
          <a
            ...
            target="_blank"
            href="https://drive.google.com/file/d/18PZus4TEgyGTBTjd0vGLukjCRtXSk7pi/view?usp=sharing"
          >
            Resume
          </a>
        </div>
