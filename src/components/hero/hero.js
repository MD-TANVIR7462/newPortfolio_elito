...
import hero1 from '../../images/slider/Tanvir.png'

import icon1 from '../../images/icon/React.png'
import icon2 from '../../images/icon/node.png'
                    ...
                    <div className="flex-1">
                        <div className="w-[660px] lg:w-[470px]  md:w-full  md:text-center">
                            <h2 className="text-white text-[90px] capitalize font-bold leading-[100px] mb-[10px]  lg:text-[65px] lg:mb-[10px] lg:leading-[75px] md:text-[45px] md:leading-[45px]  col:text-[35px] col:leading-[35px] col:mb-[0px]">
                                ...
                                I am Tanvir.</h2>
                            <h5 className="text-[#59C378] text-[32px] capitalize font-semibold leading-[39px] mb-[20px] lg:text-[28px] md:text-[22px] md:mb-[10px] col:text-[20px]  col:mb-[5px]">MERN Stack Developer</h5>
                            <p className="text-white text-[19px] capitalize font-normal leading-[33px] mb-[30px] col:text-[15px] col:leading-[28px] md:mx-[80px] col:mx-0">I'm a Full Stack Developer — crafting fast, modern, and responsive web experiences.</p>
